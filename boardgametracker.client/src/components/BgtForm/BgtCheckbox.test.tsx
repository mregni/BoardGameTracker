...
describe('BgtCheckbox', () => {
  ...
  describe('Rendering', () => {
    it('should render checkbox with label', () => {
      renderWithTheme(
        <BgtCheckbox field={mockField} id="test-checkbox" label="Test Label" />
      );
    ...
    it('should render unchecked by default', () => {
      renderWithTheme(
        <BgtCheckbox field={mockField} id="test-checkbox" label="Test" />
      );
    ...
    it('should have correct id', () => {
      renderWithTheme(
        <BgtCheckbox field={mockField} id="my-checkbox" label="Test" />
      );
      const checkbox = screen.getByRole('checkbox');
    ...
    it('should associate label with checkbox via htmlFor', () => {
      renderWithTheme(
        <BgtCheckbox field={mockField} id="linked-checkbox" label="Linked Label" />
      );
  ...
  describe('Interaction', () => {
    ...
    it('should be clickable via label', async () => {
      const user = userEvent.setup();
      renderWithTheme(
        <BgtCheckbox field={mockField} id="test-checkbox" label="Click Me" />
      );
  ...
  describe('Disabled State', () => {
    it('should be disabled when disabled prop is true', () => {
      renderWithTheme(
        <BgtCheckbox field={mockField} id="test-checkbox" label="Test" disabled />
      );
      const checkbox = screen.getByRole('checkbox');
