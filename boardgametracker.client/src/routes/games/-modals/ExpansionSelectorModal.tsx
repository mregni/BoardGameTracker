  ...
  return (
    <BgtDialog open={open}>
      <BgtDialogContent>
        ...
        <BgtDialogClose>
          <BgtButton variant="soft" color="cancel" onClick={() => setOpen(false)} disabled={isLoading || isPending}>
            {t('common.cancel')}
          </BgtButton>
          <BgtButton type="button" variant="soft" disabled={isLoading} onClick={saveModal || isPending}>
