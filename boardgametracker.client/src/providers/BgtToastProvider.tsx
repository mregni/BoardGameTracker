...
const ToastContext = createContext<{
  ...
  showInfoToast: () => {
    throw new Error(
      "You can't call showInfoToast() outside of a <ToastProvider> – add it to your tree."
    );
  },
  showErrorToast: () => {
    throw new Error(
      "You can't call showErrorToast() outside of a <ToastProvider> – add it to your tree."
    );
  },
  showWarningToast: () => {
    throw new Error(
      "You can't call showWarningToast() outside of a <ToastProvider> – add it to your tree."
    );
  },
});
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={
            clsx("flex items-center w-full max-w-xs p-3 mt-2 text-white rounded-lg shadow",
