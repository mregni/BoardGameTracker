...
public class EnvironmentProvider : IEnvironmentProvider
{
    ...
    public int Port => int.TryParse(Environment.GetEnvironmentVariable("PORT"), out var parsedPort) ? parsedPort : 7178;
    public bool EnableStatistics => bool.TryParse(Environment.GetEnvironmentVariable("STATISTICS"), out var enableLogging) && enableLogging;
