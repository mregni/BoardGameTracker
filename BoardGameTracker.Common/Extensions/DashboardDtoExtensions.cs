...
{
    private static RecentActivityDto ToRecentActivityDto(this Session session)
    {
    ...
    private static DashboardTopPlayerDto ToDashboardTopPlayerDto(
    ...
    private static RecentGameDto ToRecentAddedGameDto(this Game game)
    {
